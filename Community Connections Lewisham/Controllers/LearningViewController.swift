...
class LearningViewController: UIViewController, TickboxCellDelegate {
    ...
    @IBAction func nextPressed(_ sender: UIButton) {
        ReferralForm.referral.learningSupport = Array(ticks.keys)
        self.performSegue(withIdentifier: K.segues.housingSegue, sender: self)
    }
