...
class NOKViewController: UIViewController, UITextFieldDelegate {
    ...
    @IBAction func nextPressed(_ sender: UIButton) {
        ...
        if nameField.text != "" && relationshipField.text != "" && contactWarning.alpha == 0 {
            ...
            ReferralForm.referral.nokRelation = "Next of Kin Relation: \(relationshipField.text ?? "")"
