...
class FinancesViewController: UIViewController, TickboxCellDelegate {
    ...
    let support = ["Support Accessing Free / Low-Cost Food",
    ...
    @IBAction func nextPressed(_ sender: UIButton) {
        ReferralForm.referral.financesSupport = Array(ticks.keys)
        self.performSegue(withIdentifier: K.segues.safetySegue, sender: self)
    }
    
    
}

extension FinancesViewController: UITableViewDataSource {
