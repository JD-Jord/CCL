...
class SafetyViewController: UIViewController, TickboxCellDelegate {
    ...
    let support = ["Domestic Violence / Violence Against Women and Girls",
                   "Fire Brigade Safety Check and Free Smoke Alarm",
                   "Home Security / Police Advice",
    ...
    @IBAction func nextPressed(_ sender: UIButton) {
        ReferralForm.referral.safetySupport = Array(ticks.keys)
        self.performSegue(withIdentifier: K.segues.learningSegue, sender: self)
    }
...
extension SafetyViewController: UITableViewDataSource {
